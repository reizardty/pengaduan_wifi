			...
			<div class="col-xl-12 col-lg-12 col-md-12">
				<div class="card o-hidden border-0 shadow-lg my-5">
					<div class="card-body p-0">
						...
						<div class="row">
							<div class="col-lg-6 d-lg-block bg-register-image" style="background-image: url('../assets/img/ilus-register.png'); max-width: 100%; background-size : contain; background-repeat: no-repeat;"></div>
							<div class="col-lg-6">
								<div class="p-5">
									<div class="text-center">
										<h1 class="h6 text-gray-900 mb-4"><i class="fas fa-wifi" style="font-size: 52px; color: #4e73df;"></i></h1>
										<h1 class="h3 text-primary mb-4"><b>Pasang Baru</b></h1>
									</div>
									...
									<hr>
									<div class="text-center">
										<a class="small text-primary" href="<?= base_url('AuthLogin'); ?>" style="font-size:14px;">Sudah
