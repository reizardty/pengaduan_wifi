		...
		<div class="col-lg-12">
			...
			<?php if ($session['status'] == 'no') { ?>
				<div class="alert alert-danger" role="alert">
					<h4 align="center">MAAF AKUN ANDA BELUM DIKONFIRMASI </h4>
				</div>
			<?php } ?>
						...
						<div class="row no-gutters align-items-center">
							<div class="col mr-2">
								<div class="h5 text-md font-weight-bold text-uppercase">
									<a href="<?= base_url('MemberControl/pengaduan'); ?>" class="text-white">Pengaduan Keluhan</a>
								</div>
							</div>
							<div class="col-auto">
				...
				<div class="card bg-gradient-primary text-white shadow h-100 py-2">
					<div class="card-body">
						<div class="row no-gutters align-items-center">
							<div class="col mr-2">
								<div class="h5 text-md font-weight-bold text-uppercase">
									<a href="<?= base_url('MemberControl/pengumuman'); ?>" class="text-white">Info
										Pengumuman</a>
								</div>
							</div>
							<div class="col-auto">
