...
<div class="container">
	<!-- Page Heading -->
	<h1 class="h3 mb-2 text-gray-800">Chatting Pelanggan</h1>
			...
			$.ajax({
				...
				success: function(data) {
					...
					for (var i = 0; i < data.length; i++) {
						...
						var btn1 = '<a href="http://localhost/pdam/AdminControl/chat_pelanggan?id=' + data[i]["id_user"] + '&name=' + data[i]["name"] + '"   target="_blank" type="button" class="btn btn-xs btn btn-light btn_chat"><i class="far fa-comment"></i>' + data[i]["name"] + '</a>';
