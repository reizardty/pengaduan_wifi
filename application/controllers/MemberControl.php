...
class MemberControl extends CI_Controller{
	...
	public function pengaduan(){
		...
		$this->load->view('template/sidebar', $datacontent, $data);
		$this->load->view('template/topbar', $datacontent, $data);
		$this->load->view('template/member/pengaduan', $data);
		$this->load->view('template/footer');
	}
	...
	// fungsi get data tanggapan konsultasi 
	...
	// fungsi get data keluhan personal 
	...
	// fungsi get data detail pengumuman 
	...
	public function kirim_pengaduan(){
		...
		$data['catatan'] = $this->input->post('catatan');
		$result = $this->MemberModel->tambah_keluhan($data);
		redirect("MemberControl/rekap_keluhan");
	}
}
